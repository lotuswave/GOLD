...
public class TEST_DGLD_HF_EMEA_EU_BCT_010_Validating_the_MiniCart_and_shopping_cart_pages {

	String datafile = "Hydroflask_EMEA//GoldHydroEMEA_TestData.xlsx";
	GoldHydro_EMEA_Helper Hydro = new GoldHydro_EMEA_Helper(datafile,"DataSet");

	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
	public void Validating_the_MiniCart_and_shopping_cart_pages() throws Exception {
	 ...
	 /*     Shoppingcart Validation:    */
			...
			Hydro.addDeliveryAddress_Guestuser("eu_Address");
