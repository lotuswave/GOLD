...
public class TEST_DGLD_HF_EMEA_EU_BCT_012_Checkout_with_RegisterUserCC_Simple_Configurable_and_Bundle_products_cc {
	...
	public void Validating_Checkout_with_Register_UserCC_Simple_Configurable_and_Bundle_products () throws Exception {
		...
		try {
			...
			Hydro.login_Hydroflask("eu_Address");
...
//			Hydro.Addtocart_Bundle("Bundle product");
			...
			Hydro.RegaddDeliveryAddress("eu_Address");
