...
public class Test_DGLD_HF_EMEA_RT_035_Validating_the_product_video_in_PDP_page {

	String datafile = "Hydroflask_EMEA//GoldHydroEMEA_TestData.xlsx";
	GoldHydro_EMEA_Helper Hydro = new GoldHydro_EMEA_Helper(datafile,"PDP");

	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
	public void Validate_product_video_functionality_in_PDP_page () throws Exception {

		try {
			Hydro.verifingHomePage();
			Hydro.search_product("Product");
			Hydro.Select_Product_Search("Product");
