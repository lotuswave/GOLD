...
public class Test_DGLD_API_DB_US_004_Validate_shipment_invoice_Return_RegisterUser_checkout_with_2differentItems_subscriptionproduct_eachqty1_CC {
	    ...
	    public void getOrderCopy() {
	        ...
	        if (items != null && !items.isEmpty()) {
	            if (items.size() >= 3) { 
	                ...
	                ThirdItemId = (Integer) items.get(2).get("item_id");
	                if (ThirdItemId != null) {
	                    System.out.println("Third item_id: " + ThirdItemId);
	                } else {
	                    System.out.println("Third item_id is null.");
	                }
	            } else {
	                System.out.println("Not enough items to get the first, Second, and Third item_id.");
	            }
	        } else {
