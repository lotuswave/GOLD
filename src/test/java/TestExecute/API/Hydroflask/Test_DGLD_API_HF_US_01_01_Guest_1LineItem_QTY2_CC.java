...
public class Test_DGLD_API_HF_US_01_01_Guest_1LineItem_QTY2_CC {
    ...
    public void getOrderCopy() {
    	...
    	RestAssured.baseURI = "https://na-preprod.hele.digital/rest/hydroflask/V1/orders/12799367/";
        RequestSpecification request = RestAssured.given();
        request.header("Content-Type", "application/json");
...
//      System.out.println("Get Order Copy Response: " + formattedJson);
    ...
    public void shipOrder_And_InvoiceOrder() {
        ...
        String delivery_numberBase ="138";
