...
public class TEST_HYF_EMEA_API_Integration_ST_004__Validate_Shipment_Invoice_Return_RegisteredUserCheckout_2LineItems_WithGiftCardPurchase_CC {
// Return for refund (Partial return)
	 private String apiKey;
	    ...
	    public void getOrderCopy() {
	    	...
	    	RestAssured.baseURI = "https://emea-preprod.hele.digital/rest/all/V1/orders/"+MagentoOrder_ID+"/";
	        RequestSpecification request = RestAssured.given();
	        request.header("Content-Type", "application/json");
...
//	      System.out.println("Get Order Copy Response: " + formattedJson);
	    ...
	    public void shipOrder() {
	        ...
	        String trackingNumberBase = "1025533";
	 ...
	 public void createRma() throws InterruptedException {
		...
		System.out.println(apiKey);
	     ...
	     String Increment_Base = "17118qa9";
