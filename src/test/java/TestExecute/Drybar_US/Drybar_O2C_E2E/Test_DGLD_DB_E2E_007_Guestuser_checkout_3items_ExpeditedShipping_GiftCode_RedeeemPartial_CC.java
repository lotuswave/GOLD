...
public class Test_DGLD_DB_E2E_007_Guestuser_checkout_3items_ExpeditedShipping_GiftCode_RedeeemPartial_CC {

	String datafile = "Drybar_US//GoldDrybarTestData.xlsx";
	GoldDrybarusE2EHelper Drybar = new GoldDrybarusE2EHelper(datafile,"Drybar_E2E");;

	@Test(retryAnalyzer = Utilities.RetryAnalyzer.class)
	public void Verifying_Guestuser_checkout_3items_Expedited_shipping_GiftCode_RedeeemPartial () throws Exception {
