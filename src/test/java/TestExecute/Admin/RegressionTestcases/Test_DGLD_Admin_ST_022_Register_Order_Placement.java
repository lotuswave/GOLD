...
public class Test_DGLD_Admin_ST_022_Register_Order_Placement {
	...
	public void Catalog_product_update() throws Exception {
		try {
			...
			Admin.Customers();
			Admin.Allcustomers();
			Admin.SelectCustomer_Edit("OXO_Store");

			Admin.Click_CreatNewOrders();

			Admin.Select_store("OXO_Store");
			Admin.Add_product_SKU("OXO_Store");
