...
public class Test_DGLD_OS_FR_043_Guest_User_Checkout_Discount_Visa_card {
	...
	public void Verifying_Guest_User_Checkout_Visa_Card () throws Exception {
        ...
        Osprey_ReEu.addDeliveryAddress_Guestuser("Fr_Address");
        Osprey_ReEu.selectshippingmethod("FR shipping method");
