...
public class Test_DGLD_OS_SW_043_Guest_User_Checkout_Visa_card {
	...
	public void Verifying_Guest_User_Checkout_Visa_Card () throws Exception {
        ...
        Osprey_ReEu.addDeliveryAddress_Guestuser("SW_Address");
        Osprey_ReEu.selectshippingmethod("Sw shipping method");
