...
//			Common.assertionCheckwithReport(errorpopup.equals("display)),"vlaidating the pop up message after submittion","After submit button user able see the error popup","Sucessfully popup message has been diplayed after subit button","Failed to get error message after click on submit button");
			...
			e.printStackTrace();
			report.addFailedLog("validating store logo", "System directs the user back to Find a Store",
					"Sucessfully user back to Find a Store page",
...
public void Click_Instock() {
	...
	try {
		...
		e.printStackTrace();
		report.addFailedLog("validating instock page", "System directs the user back to the instock page",
				"Sucessfully user back to instock page",
				Common.getscreenShotPathforReport("faield to get back to instock page"));
		Assert.fail();
	}
...
try {
	...
	e.printStackTrace();
		report.addFailedLog("validating product listing page", "System directs the user back to the product listing page",
				"Sucessfully user back to product listing page",
				Common.getscreenShotPathforReport("faield to get back product listing page"));
		Assert.fail();
}
}
...
public void click_Retailer() {
	...
	e.printStackTrace();
	report.addFailedLog("validating Retailers page", "System directs the user back to Retailers page",
			"Sucessfully user back to Retailers page",
...
try {
	...
	e.printStackTrace();
		report.addFailedLog("validating Links page", "System directs the user back to the Links page",
				"Sucessfully user back to Links page",
				Common.getscreenShotPathforReport("faield to get back to Links page"));
		Assert.fail();
}
}
public void verifingRetailerHours() {
    ...
    e.printStackTrace();
    report.addFailedLog("validating hours page", "System directs the user back to the hours page",
            "Sucessfully user back to hours page",
            Common.getscreenShotPathforReport("faield to get back to "));
    Assert.fail();
}
}
public void verifingRetailerBrowser() {
    ...
    e.printStackTrace();
    report.addFailedLog("validating browser page", "System directs the user back to the Browser page",
            "Sucessfully user back to browser page",
            Common.getscreenShotPathforReport("faield to get back to browser page"));
    Assert.fail();
}
}
